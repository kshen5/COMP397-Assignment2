module scenes {
    export class Instructions extends objects.Scene {
        ...
        private readonly _flavourText: string = "You are the developer of a new player for the USA's \"Space Force\". "
        ...
        private readonly _controlsText: string = "mouse up and down\n "
            + "space to attack";
